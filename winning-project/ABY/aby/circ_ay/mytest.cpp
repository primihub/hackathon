                   ...
                   std::string *address, uint16_t *port, int32_t *test_op)
{
  ...
  parsing_ctx options[] = {
    ...
    //   parsing_ctx options[] = {
    //     { (void *)&int_role, T_NUM, "r", "Role: 0/1", true, false },
    //     { (void *)nvals, T_NUM, "n", "Number of parallel operation
    //     elements",
    //       false, false },
    //     { (void *)bitlen, T_NUM, "b", "Bit-length, default 32", false, false
    //     }, { (void *)secparam, T_NUM, "s", "Symmetric Security Bits,
    //     default: 128",
    //       false, false },
...
main (int argc, char **argv)
{
  ...
  test_pppt_circuit (role, address, port, seclvl, 32, nthreads, mt_alg,
                     S_ARITH, thr);
